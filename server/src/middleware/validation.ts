...
export const registerSchema = z.object({
  ...
  senha: z.string().regex(/^\d{6}$/, 'A senha deve ter exatamente 6 números'),
...
export const resetPasswordSchema = z.object({
  ...
  novaSenha: z.string().regex(/^\d{6}$/, 'A senha deve ter exatamente 6 números'),
});
...
export const portalChangePasswordSchema = z.object({
  ...
  nova_senha: z.string().regex(/^\d{6}$/, 'A senha deve ter exatamente 6 números'),
});
